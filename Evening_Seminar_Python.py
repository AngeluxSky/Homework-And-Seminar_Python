...
# one_dict = [{"V": "S001"}, {"V": "S002"}, {"VI": "S001"}, {"VI": "S005"},
...
# Даны два списка чисел. Требуется вывести те элементы первого list
# (в том порядке, в каком они идут в первом списке), которых нет во втором list.
# Пользователь вводит число N - количество элементов в первом массиве,
# затем N чисел - элементы списка.
# Затем число M - количество элементов во втором списке.
# Затем элементы второго списка.

# first_size = int(input('Введите количество элементов первого массива: '))
#
# print(first_array := [int(input('Введите элемент: ')) for _ in range(first_size)])
#
# second_size = int(input('Введите количество элементов второго массива: '))
#
# print(second_array := [int(input('Введите элемент: ')) for _ in range(second_size)])
#
