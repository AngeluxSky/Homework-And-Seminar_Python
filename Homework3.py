...
# list_f = input('Задайте элементы списка(используя пробел): ').split()
# arr = list(map(int, list_f))
...
#
# new_word = input("Введите слово: ").upper()
# summ = 0
# for i in new_word:
